class Headroom < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/headroomlabs-ai/headroom/releases/download/v0.37.0/headroom_ai-0.37.0-cp310-abi3-macosx_10_12_x86_64.whl"
      sha256 "d89fd5858e701ada53d01849f73039d891fad84d9eb370f952d56581962d9cf8"

      resource "hf-xet" do
        url "https://files.pythonhosted.org/packages/a2/50/7afa2c9c787405864fc47a0d1bbc02c62e9101947ed43c1f43899fc7d91d/hf_xet-1.6.0-cp38-abi3-macosx_10_12_x86_64.whl"
        sha256 "633dc0cd71d32da58ab8c03ad38e2fac452c15c2b0a2866ebf6ededfe0a5061d"
      end

      resource "litellm" do
        url "https://files.pythonhosted.org/packages/c8/90/2ef5e33b0a67b309be124a77e5098a261beffe28439221dbbc28e5f02e2e/litellm-1.98.0-cp310-abi3-macosx_10_12_x86_64.whl"
        sha256 "9fda3497f1ec4686c943ce2aeab5767f8fb4a5989305d4b28d6d5d7e488b850c"
      end
    ...
    on_arm do
      url "https://github.com/headroomlabs-ai/headroom/releases/download/v0.37.0/headroom_ai-0.37.0-cp310-abi3-macosx_11_0_arm64.whl"
      sha256 "b4392f68a8d02d74c62c1734cf5bf327511dcc72678f01669f44f0612944d59c"
      ...
      resource "litellm" do
        url "https://files.pythonhosted.org/packages/b0/56/b4569b4ef3640732d5770e0d3f46a395fd20f35594db1f65629595daed00/litellm-1.98.0-cp310-abi3-macosx_11_0_arm64.whl"
        sha256 "b89b6a0fc179d881191579f5309e622173dca802ee991b92e382acb918eea437"
      end
  ...
  on_linux do
    on_intel do
      url "https://github.com/headroomlabs-ai/headroom/releases/download/v0.37.0/headroom_ai-0.37.0-cp310-abi3-manylinux_2_28_x86_64.whl"
      sha256 "2efc5cdf681a10c5fc7a2a271a471179c409074537045f682b10e4d724976f46"
      ...
      resource "litellm" do
        url "https://files.pythonhosted.org/packages/69/de/ab46b521e2a6e6a94a5cb91ba3debd6c4e922feaeb47158a389400b0a0fe/litellm-1.98.0-cp310-abi3-manylinux_2_28_x86_64.whl"
        sha256 "150993180bf049feafa3e20cf46ca0978c69cc66e2ef1639a47e852c682a4721"
      end
    ...
    on_arm do
      url "https://github.com/headroomlabs-ai/headroom/releases/download/v0.37.0/headroom_ai-0.37.0-cp310-abi3-manylinux_2_28_aarch64.whl"
      sha256 "bc30d31a6b9336155d62bbdd99f3c2f6c5a1ed3882a8730ea0cd8ede4c40fa19"

      resource "hf-xet" do
        url "https://files.pythonhosted.org/packages/9a/69/1f0cbc2fb22ae6082d094f743d1b8945a3f36f6089cb95f42b7ee348cda7/hf_xet-1.6.0-cp38-abi3-manylinux_2_28_aarch64.whl"
        sha256 "0e6e21fa3cdfcdcd76748564bf593870a5e013f47d97cf10aed63aa222cff5b7"
      end

      resource "litellm" do
        url "https://files.pythonhosted.org/packages/d9/a7/9f03de0e8d767ff27964ea99bbf07e4c37a12f9d3c168c09f40e068535d4/litellm-1.98.0-cp310-abi3-manylinux_2_28_aarch64.whl"
        sha256 "3a95260f087a4cf763da85bbeeb2efa82caec243ad2394c9e6362ff747963738"
      end
  ...
  resource "ast-grep-cli" do
    url "https://files.pythonhosted.org/packages/82/ad/2f00726d90bcdbf821e1f8893a219d531d3a4a3a525c0ea7554c36b44328/ast_grep_cli-0.45.2.tar.gz"
    sha256 "300bd5161bd7e6db532ea330647137381f461e0e995b72e56e5e3abcd611ebc3"
  end
  ...
  def install
    ...
    binary_resources = %w[hf-xet litellm tokenizers]
    venv.pip_install resources.reject { |resource| binary_resources.include?(resource.name) }

    binary_resources.each do |name|
      resource(name).stage do
        venv.pip_install Pathname(Dir["*.whl"].fetch(0))
      end
    end

    venv.pip_install_and_link Pathname(Dir["*.whl"].fetch(0))
  end
